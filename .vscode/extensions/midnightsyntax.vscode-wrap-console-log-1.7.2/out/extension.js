...
function handle(target, prefix, input, formatAs) {
    new Promise((resolve, reject) => {
        ...
        if (ran == undefined) {
            ...
            if (prefix) {
                if (getSetting("alwaysInputBoxOnPrefix") == true || input) {
                    ...
                    wrapData.txt = getSetting('format.wrap.prefixString').replace('$func', getSetting('format.wrap.prefixFunctionName')).replace(/[$]var/g, wrapData.item);
                    resolve(wrapData);
                }
            }
            else {
        ...
        function SetCursor(line, character) {
            let tpos;
