...
import img1 from "./hindustan.png";
import img2 from "./hinduexplore.png";
import img3 from "./hindustanlogin.png";
import img4 from "./hindustanpaymet.png";
  ...
  return (
    <div className={style.project1body}>
      ...
      <div className={style.procontentdiv}>
        ...
        <p>
          Hindustan Times is an newspaper website used to know the
         world-wide news,daily headlines from politics, business, technology, photos, videos, latest English news and much more.
        </p>
        ...
        <div className={style.btndivv}>
          <button className={style.btnpro} style={{ backgroundColor: "black" }}>
            <a
              ...
              target="_blank"
              href="https://github.com/11-DEEPAK-KUMAR-11/HINDUSTAN-TIMES"
            >
              <span>
                <svg
                  style={{
          ...
          >
            <a
              ...
              style={{ textDecoration: "none", color: "white" }}
              target="_blank"
              href="https://tranquil-starlight-3441db.netlify.app/"
            >
              <span>
                <svg
                  style={{
