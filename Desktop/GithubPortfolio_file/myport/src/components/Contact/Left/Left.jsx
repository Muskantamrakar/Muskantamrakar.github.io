    ...
    <div className={style.leftbody}>
      <div className={style.wrapper}>
        ...
        <div className={style.maildiv}>
          ...
          <a href="mailto:muskantamrakar2442@gmail" style={{ textDecoration: "none" }}>
           
            <span style={{ paddingLeft: "55px", cursor: "pointer" }}>
              muskantamrakar2442@gmail
            </span>
          </a>
        </div>
        ...
        <div className={style.icondiv}>
          <a target="_blank" href="https://github.com/Muskantamrakar">
            <AiOutlineGithub fontSize={"25px"} color={"black"}/>
          </a>
          <a target="_blank" href="https://www.linkedin.com/in/muskan-tamrakar-7a5258236">
            <BsLinkedin fontSize={"25px"} color={"black"}/>
          </a>
