...
const Navbar = () => {
    ...
    return (
        <div className={styles.header}>
            <div><Link to="/"  className={styles.logo}><h1><span>ℳ𝓊𝓈𝓀𝓪𝓃</span></h1></Link></div>
                 ...
                 <Link activeClass={styles.active} to="about" spy={true} smooth={true} offset={50} duration={1000}><BsPersonCheck className={styles.navbarIcons}/>About</Link>
                  ...
                  <li>
                    {/* <Link to="/contacts">Contacts</Link> */}
                        ...
                        {/* <Link activeClass={styles.active} to="contacts" spy={true} smooth={true} offset={50} duration={1000}>Contacts</Link> */}
                </li>
                  <li>
                    <a target="_blank" href='https://drive.google.com/file/d/1qgmYILIqHQnWTDtTFa7EuXuF6Zpm5YAF/view?usp=sharing'>
